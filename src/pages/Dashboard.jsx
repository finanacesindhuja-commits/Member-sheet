          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-slate-900 border border-white/10 rounded-3xl p-6 mb-8 gap-4">
            ...
            <div className="flex items-center gap-4 w-full md:w-auto">
              <div className="flex items-center gap-2 w-full md:w-auto">
                <div className="bg-slate-950 border border-white/10 rounded-xl p-3 text-slate-400">
                  <FaSearch size={18} />
                </div>
                <input 
                  type="text" 
                  ...
                  className="w-full md:w-56 bg-slate-950 border border-white/10 rounded-xl px-4 py-2.5 text-white focus:outline-none focus:border-blue-500 transition-colors text-sm"
                />
              </div>
